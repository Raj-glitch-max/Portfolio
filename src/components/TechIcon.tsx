...
export const TechIcon: React.FC<TechIconProps> = ({ name, className = "w-6 h-6", color }) => {
    ...
    const icons: Record<string, React.ReactNode> = {
        ...
        rabbitmq: (
            <svg viewBox="0 0 24 24" fill={iconColor} className={className}>
                <path d="M21.5 2h-19C1.12 2 0 3.12 0 4.5v15C0 20.88 1.12 22 2.5 22h19c1.38 0 2.5-1.12 2.5-2.5v-15C24 3.12 22.88 2 21.5 2zm-1 16.5h-2v-2h2v2zm0-3.5h-2v-8h2v8z" />
            </svg>
        ),
        jaeger: (
            <svg viewBox="0 0 24 24" fill={iconColor} className={className}>
                <path d="M12 2L2 7v10l10 5 10-5V7l-10-5zm0 2.2l6.5 3.3v6.5l-6.5 3.3-6.5-3.3V7.5L12 4.2z" />
                <circle cx="12" cy="12" r="3" />
            </svg>
        ),
        ansible: (
            <svg viewBox="0 0 24 24" fill={iconColor} className={className}>
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.5 16.5l-5.2-9.8-3.3 6.2h-2l4.5-8.5 6 11.1h-2z" />
            </svg>
        ),
        typescript: (
            <svg viewBox="0 0 24 24" fill={iconColor} className={className}>
                <path d="M0 12v12h24V0H0v12zm19.341-.956c.61.152 1.074.423 1.501.865.221.236.549.666.575.77.008.03-1.036.73-1.668 1.123-.023.015-.115-.084-.217-.236-.31-.45-.633-.644-1.128-.678-.728-.05-1.196.331-1.192.967a.88.88 0 0 0 .102.45c.16.331.458.53 1.39.934 1.719.744 2.454 1.235 2.911 1.946.51.797.576 2.041.159 2.927-.457.971-1.622 1.634-3.142 1.79-.474.049-1.547.027-1.992-.038-.95-.138-1.858-.515-2.367-1.002-.177-.168-.518-.606-.489-.627.011-.008.209-.141.44-.295l.817-.544.185-.123.163.218c.242.32.736.76 1.05.936.876.491 2.07.441 2.654-.11.26-.246.369-.53.369-.958 0-.361-.023-.487-.15-.705-.184-.311-.543-.53-1.573-.96-1.177-.492-1.686-.796-2.177-1.299-.364-.373-.62-.813-.754-1.299-.11-.398-.135-1.361-.046-1.78.315-1.486 1.426-2.428 3.185-2.699.464-.071 1.54-.034 1.992.066z" />
            </svg>
        ),
        groovy: (
            <svg viewBox="0 0 24 24" fill={iconColor} className={className}>
                <path d="M5.868 8.7c-.044.238-.044.476-.044.714 0 3.808 3.09 6.898 6.898 6.898 3.808 0 6.898-3.09 6.898-6.898 0-.238 0-.476-.044-.714h-13.708zm6.854-6.7c-4.762 0-8.722 3.96-8.722 8.722 0 4.762 3.96 8.722 8.722 8.722 4.762 0 8.722-3.96 8.722-8.722 0-4.762-3.96-8.722-8.722-8.722zm0 15.62c-3.808 0-6.898-3.09-6.898-6.898 0-3.808 3.09-6.898 6.898-6.898 3.808 0 6.898 3.09 6.898 6.898 0 3.808-3.09 6.898-6.898 6.898z" />
            </svg>
        ),
        oracle: (
            <svg viewBox="0 0 24 24" fill={iconColor} className={className}>
